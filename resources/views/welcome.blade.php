  ...
  <body>
    ...
    ***********************************-->
    <div id="main-wrapper">
      ...
      <div class="quixnav">
        <div class="quixnav-scroll">
          <ul class="metismenu" id="menu">
            ...
            <li>
              <a href="./index.html" aria-expanded="false"><i class="icon icon-app-store"></i><span class="nav-text">Dashboard</span></a>
            </li>
            <li>
      ...
      <div class="footer">
        <div class="copyright">
          <p>Copyright © Designed &amp; Developed by <a href="https://instagram.com/handikafdl" target="_blank">Handika Fadli</a> 2024</p>
        </div>
      </div>
      <!--**********************************
            Footer end
