	...
	<div class="quixnav-scroll">
		<ul class="metismenu" id="menu">
			...
			<li class="{{ Request::is('admin/lowongan*') ? 'mm-active' : '' }}">
				<a href="/admin/lowongan" class="{{ Request::is('admin/lowongan*') ? 'mm-active' : '' }}" aria-expanded="false"><i class="icon-list"></i><span class="nav-text">Lowongan</span></a>
			</li>
			<li class="{{ Request::is('admin/post-lowongan*') ? 'mm-active' : '' }}">
				<a href="/admin/post-lowongan" class="{{ Request::is('admin/post-lowongan*') ? 'mm-active' : '' }}" aria-expanded="false"><i class="icon icon-layout-25"></i><span class="nav-text">Postingan</span></a>
			</li>
			<li>
